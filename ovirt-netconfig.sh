...
INFO_TABLE="
0,192.168.0.17,202,102,$MTU0,1s0,$NET0,yes,$GW0,yes,no
1,192.168.1.17,201,101,$MTUx,7s0,$NET1,yes,$GW1,no,yes
2,192.168.2.17,200,100,$MTUx,8s0,$NET2,no,$GW2,yes,no
"
